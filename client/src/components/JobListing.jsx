      ...
      <section className="w-full lg:w-3/4 text-gray-800 max-lg:px-4">
        ...
        {jobs.length>0 && (
          <div className="flex items-center justify-center space-x-2 mt-10">
            <a href="job-list">
              <img onClick={() => setCurrentPage(Math.max(currentPage-1,1))} src={assets.left_arrow_icon}></img>
            </a>
            ...
            <a href="job-list">
              <img onClick={() => setCurrentPage(Math.min(currentPage+1,Math.ceil(jobs.length/6)))} src={assets.right_arrow_icon}></img>
            </a>
          </div>
        )}
      </section>
